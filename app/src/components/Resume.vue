    ...
    <div class="leftCol m_box">
      ...
      <a :href="'https://twitter.com/' + person.contact.twitter">
        <div class="item">
          ...
          <div class="text">@{{ person.contact.twitter }}</div>
        </div>
      </a>
      ...
      <a :href="'https://t.me/' + person.contact.telegram">
        <div class="item">
          ...
          <div class="text">@{{ person.contact.telegram }}</div>
        </div>
      </a>
      ...
      <div class="item">
        ...
        <div
          class="infos"
          v-for="personal_projects in person.personal_projects"
          :key="personal_projects.project"
        >
          <div class="right">
